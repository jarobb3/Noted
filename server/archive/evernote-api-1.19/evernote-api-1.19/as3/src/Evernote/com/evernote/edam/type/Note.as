        ...
        switch (field.id)
        {
          ...
          case TAGGUIDS:
            if (field.type == TType.LIST) {
              {
                var _list121:TList = iprot.readListBegin();
                this.tagGuids = new Array();
                for (var _i122:int = 0; _i122 < _list121.size; ++_i122)
                {
                  var _elem123:String;
                  _elem123 = iprot.readString();
                  this.tagGuids.push(_elem123);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case RESOURCES:
            if (field.type == TType.LIST) {
              {
                var _list124:TList = iprot.readListBegin();
                this.resources = new Array();
                for (var _i125:int = 0; _i125 < _list124.size; ++_i125)
                {
                  var _elem126:Resource;
                  _elem126 = new Resource();
                  _elem126.read(iprot);
                  this.resources.push(_elem126);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.tagGuids != null) {
        if (isSetTagGuids()) {
          oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
          {
            ...
            for each (var elem130:* in this.tagGuids)            {
      ...
      if (this.resources != null) {
        if (isSetResources()) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for each (var elem131:* in this.resources)            {
              elem131.write(oprot);
            }
            oprot.writeListEnd();
          }
      ...
      if (this.tagNames != null) {
        if (isSetTagNames()) {
          oprot.writeFieldBegin(TAG_NAMES_FIELD_DESC);
          {
            ...
            for each (var elem132:* in this.tagNames)            {
