        ...
        switch (field.id)
        {
          ...
          case NOTES:
            if (field.type == TType.LIST) {
              {
                var _list79:TList = iprot.readListBegin();
                this.notes = new Array();
                for (var _i80:int = 0; _i80 < _list79.size; ++_i80)
                {
                  var _elem81:Note;
                  _elem81 = new Note();
                  _elem81.read(iprot);
                  this.notes.push(_elem81);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i83:int = 0; _i83 < _list82.size; ++_i83)
                {
                  ...
                  this.stoppedWords.push(_elem84);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i86:int = 0; _i86 < _list85.size; ++_i86)
                {
                  ...
                  this.searchedWords.push(_elem87);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.notes != null) {
        oprot.writeFieldBegin(NOTES_FIELD_DESC);
        {
          ...
          for each (var elem88:* in this.notes)          {
            elem88.write(oprot);
          }
          oprot.writeListEnd();
        }
      ...
      if (this.stoppedWords != null) {
        if (isSetStoppedWords()) {
          oprot.writeFieldBegin(STOPPED_WORDS_FIELD_DESC);
          {
            ...
            for each (var elem89:* in this.stoppedWords)            {
              oprot.writeString(elem89);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (this.searchedWords != null) {
        if (isSetSearchedWords()) {
          oprot.writeFieldBegin(SEARCHED_WORDS_FIELD_DESC);
          {
            ...
            for each (var elem90:* in this.searchedWords)            {
