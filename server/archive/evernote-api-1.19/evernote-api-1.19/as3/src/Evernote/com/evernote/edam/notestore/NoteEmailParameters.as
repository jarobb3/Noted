      ...
      while (true)
      {
        ...
        switch (field.id)
        {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i176:int = 0; _i176 < _list175.size; ++_i176)
                {
                  ...
                  this.toAddresses.push(_elem177);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case CCADDRESSES:
            if (field.type == TType.LIST) {
              {
                var _list178:TList = iprot.readListBegin();
                this.ccAddresses = new Array();
                for (var _i179:int = 0; _i179 < _list178.size; ++_i179)
                {
                  var _elem180:String;
                  _elem180 = iprot.readString();
                  this.ccAddresses.push(_elem180);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.toAddresses != null) {
        if (isSetToAddresses()) {
          oprot.writeFieldBegin(TO_ADDRESSES_FIELD_DESC);
          {
            ...
            for each (var elem181:* in this.toAddresses)            {
      ...
      if (this.ccAddresses != null) {
        if (isSetCcAddresses()) {
          oprot.writeFieldBegin(CC_ADDRESSES_FIELD_DESC);
          {
            ...
            for each (var elem182:* in this.ccAddresses)            {
              oprot.writeString(elem182);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
