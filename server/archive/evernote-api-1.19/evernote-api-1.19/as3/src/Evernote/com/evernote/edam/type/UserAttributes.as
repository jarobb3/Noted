            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i32:int = 0; _i32 < _list31.size; ++_i32)
                {
                  ...
                  this.viewedPromotions.push(_elem33);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i35:int = 0; _i35 < _list34.size; ++_i35)
                {
                  ...
                  this.recentMailedAddresses.push(_elem36);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.viewedPromotions != null) {
        if (isSetViewedPromotions()) {
          oprot.writeFieldBegin(VIEWED_PROMOTIONS_FIELD_DESC);
          {
            ...
            for each (var elem37:* in this.viewedPromotions)            {
      ...
      if (this.recentMailedAddresses != null) {
        if (isSetRecentMailedAddresses()) {
          oprot.writeFieldBegin(RECENT_MAILED_ADDRESSES_FIELD_DESC);
          {
            ...
            for each (var elem38:* in this.recentMailedAddresses)            {
