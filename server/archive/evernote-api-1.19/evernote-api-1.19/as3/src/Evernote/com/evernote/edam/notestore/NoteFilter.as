        ...
        switch (field.id)
        {
          ...
          case TAGGUIDS:
            if (field.type == TType.LIST) {
              {
                var _list69:TList = iprot.readListBegin();
                this.tagGuids = new Array();
                for (var _i70:int = 0; _i70 < _list69.size; ++_i70)
                {
                  var _elem71:String;
                  _elem71 = iprot.readString();
                  this.tagGuids.push(_elem71);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.tagGuids != null) {
        if (isSetTagGuids()) {
          oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
          {
            ...
            for each (var elem72:* in this.tagGuids)            {
              oprot.writeString(elem72);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
