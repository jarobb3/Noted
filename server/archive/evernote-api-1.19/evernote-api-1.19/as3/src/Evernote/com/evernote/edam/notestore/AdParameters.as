        ...
        switch (field.id)
        {
          ...
          case IMPRESSIONS:
            if (field.type == TType.LIST) {
              {
                var _list158:TList = iprot.readListBegin();
                this.impressions = new Array();
                for (var _i159:int = 0; _i159 < _list158.size; ++_i159)
                {
                  var _elem160:AdImpressions;
                  _elem160 = new AdImpressions();
                  _elem160.read(iprot);
                  this.impressions.push(_elem160);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case CLIENTPROPERTIES:
            if (field.type == TType.MAP) {
              {
                var _map161:TMap = iprot.readMapBegin();
                this.clientProperties = new Dictionary();
                for (var _i162:int = 0; _i162 < _map161.size; ++_i162)
                {
                  var _key163:String;
                  var _val164:String;
                  _key163 = iprot.readString();
                  _val164 = iprot.readString();
                  this.clientProperties[_key163] = _val164;
                }
                iprot.readMapEnd();
              }
            } else { 
      ...
      if (this.impressions != null) {
        if (isSetImpressions()) {
          oprot.writeFieldBegin(IMPRESSIONS_FIELD_DESC);
          {
            ...
            for each (var elem165:* in this.impressions)            {
              elem165.write(oprot);
            }
            oprot.writeListEnd();
          }
      ...
      if (this.clientProperties != null) {
        if (isSetClientProperties()) {
          oprot.writeFieldBegin(CLIENT_PROPERTIES_FIELD_DESC);
          {
            ...
            for (var _key166:* in this.clientProperties) {
              _sizeCounter167++;
            }
            oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter167));
            for (var elem168:* in this.clientProperties)            {
              oprot.writeString(elem168);
              oprot.writeString(this.clientProperties[elem168]);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
