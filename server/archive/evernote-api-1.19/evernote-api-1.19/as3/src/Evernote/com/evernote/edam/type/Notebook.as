        ...
        switch (field.id)
        {
          ...
          case SHAREDNOTEBOOKIDS:
            if (field.type == TType.LIST) {
              {
                var _list147:TList = iprot.readListBegin();
                this.sharedNotebookIds = new Array();
                for (var _i148:int = 0; _i148 < _list147.size; ++_i148)
                {
                  var _elem149:BigInteger;
                  _elem149 = iprot.readI64();
                  this.sharedNotebookIds.push(_elem149);
                }
                iprot.readListEnd();
              }
            } else { 
      ...
      if (this.sharedNotebookIds != null) {
        if (isSetSharedNotebookIds()) {
          oprot.writeFieldBegin(SHARED_NOTEBOOK_IDS_FIELD_DESC);
          {
            ...
            for each (var elem150:* in this.sharedNotebookIds)            {
