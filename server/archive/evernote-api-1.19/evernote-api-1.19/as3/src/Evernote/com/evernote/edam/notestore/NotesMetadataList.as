        ...
        switch (field.id)
        {
          ...
          case NOTES:
            if (field.type == TType.LIST) {
              {
                var _list112:TList = iprot.readListBegin();
                this.notes = new Array();
                for (var _i113:int = 0; _i113 < _list112.size; ++_i113)
                {
                  var _elem114:NoteMetadata;
                  _elem114 = new NoteMetadata();
                  _elem114.read(iprot);
                  this.notes.push(_elem114);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i116:int = 0; _i116 < _list115.size; ++_i116)
                {
                  ...
                  this.stoppedWords.push(_elem117);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SEARCHEDWORDS:
            if (field.type == TType.LIST) {
              {
                var _list118:TList = iprot.readListBegin();
                this.searchedWords = new Array();
                for (var _i119:int = 0; _i119 < _list118.size; ++_i119)
                {
                  var _elem120:String;
                  _elem120 = iprot.readString();
                  this.searchedWords.push(_elem120);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.notes != null) {
        oprot.writeFieldBegin(NOTES_FIELD_DESC);
        {
          ...
          for each (var elem121:* in this.notes)          {
            elem121.write(oprot);
          }
          oprot.writeListEnd();
        }
      ...
      if (this.stoppedWords != null) {
        if (isSetStoppedWords()) {
          oprot.writeFieldBegin(STOPPED_WORDS_FIELD_DESC);
          {
            ...
            for each (var elem122:* in this.stoppedWords)            {
      ...
      if (this.searchedWords != null) {
        if (isSetSearchedWords()) {
          oprot.writeFieldBegin(SEARCHED_WORDS_FIELD_DESC);
          {
            ...
            for each (var elem123:* in this.searchedWords)            {
