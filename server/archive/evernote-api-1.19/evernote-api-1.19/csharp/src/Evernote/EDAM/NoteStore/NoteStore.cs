      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Evernote.EDAM.Type.SharedNotebook _iter138 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i140 = 0; _i140 < _list139.Count; ++_i140)
                  {
                    ...
                    SharedNotebookIds.Add(_elem141);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      public void Write(TProtocol oprot) {
        ...
        if (SharedNotebookIds != null && __isset.sharedNotebookIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (long _iter142 in SharedNotebookIds)
            {
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Evernote.EDAM.Type.LinkedNotebook _iter146 in Success)
              {
