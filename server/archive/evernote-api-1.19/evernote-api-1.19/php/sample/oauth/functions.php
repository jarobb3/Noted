<?
  ...
  // Verify that you have successfully installed the PHP OAuth Extension
  ...
  if (OAUTH_CONSUMER_KEY == 'en-edamtest') {
    ...
    die("<span style=\"color:red\">Before using this sample code you must edit the file $configFile " .
        "and replace OAUTH_CONSUMER_KEY and OAUTH_CONSUMER_SECRET with the values that you received from Evernote. " .
        "If you do not have an API key, you can request one from " .
        "<a href=\"http://www.evernote.com/about/developer/api/\">http://www.evernote.com/about/developer/api/</a></span>");
  }
  ...
  function listNotebooks() {
    ...
    try {
      $noteStoreTrans = new THttpClient(NOTESTORE_HOST, NOTESTORE_PORT, '/edam/note/' . $_SESSION['shardId'], NOTESTORE_PROTOCOL);
  ...
  function resetSession() {
    ...
    if (isset($_SESSION['shardId'])) {
      unset($_SESSION['shardId']);
    }
